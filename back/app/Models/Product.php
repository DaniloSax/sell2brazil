...
class Product extends Model
{
    ...
    const PRODUCTS_FACTORY =  [
        ...
        ['name' => 'Mouse', 'price' => 100, 'article_code' => 789456, 'article_description' => "Mouse Gamer Redragon Cobra, Chroma RGB, 12400DPI, 7 Botões, Preto - M711 V2", 'image' => "https://m.media-amazon.com/images/I/61mpMH5TzkL._AC_SY450_.jpg"],
    ...
    {
        return $this->belongsToMany(Order::class, 'orders_products', 'product_id', 'order_id')->withPivot(['user_id', 'id']);
    }
}
